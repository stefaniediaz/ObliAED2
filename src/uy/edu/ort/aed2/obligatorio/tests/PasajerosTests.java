...
public class PasajerosTests {
    ...
    public void testRegistrarPasajero_ok() {
        ...
        checker.ok(sistema.registrarPasajero("222.422-2", "Roberto", "5255-055", Sistema.Categoria.B));
        checker.ok(sistema.registrarPasajero("5.232.422-2", "Maria", "5525-032355", Sistema.Categoria.C));
        checker.ok(sistema.registrarPasajero("1.222.422-2", "Giussepe", "55225-055", Sistema.Categoria.D));
        checker.ok(sistema.registrarPasajero("101.422-2", "Paul", "121-055", Sistema.Categoria.E));
    }
